...
/* Define colors, index 0, enabled, not selected */
  ...
  #define MENU_BKCOLOR0_DEFAULT     GUI_BLACK//GUI_LIGHTGRAY
#endif

/* Define colors, index 1, enabled, selected */
#ifndef MENU_TEXTCOLOR1_DEFAULT
  #define MENU_TEXTCOLOR1_DEFAULT   GUI_LIGHTGRAY
#endif
...
/* Define colors, index 2, disabled, not selected */
  ...
  #define MENU_TEXTCOLOR2_DEFAULT   GUI_WHITE//0x7C7C7C
#endif

#ifndef MENU_BKCOLOR2_DEFAULT
  #define MENU_BKCOLOR2_DEFAULT     GUI_BLACK//GUI_LIGHTGRAY
#endif

/* Define colors, index 3, disabled, selected */
#ifndef MENU_TEXTCOLOR3_DEFAULT
  #define MENU_TEXTCOLOR3_DEFAULT   GUI_BLACK//GUI_LIGHTGRAY
#endif

#ifndef MENU_BKCOLOR3_DEFAULT
  #define MENU_BKCOLOR3_DEFAULT     GUI_LIGHTBLUE//0x980000
#endif
