...
#define SD_SPI_ReadWriteByte SPI1_ReadWriteByte

SDCardInfo SDCard_Info;
u8  SD_Type=0;//SD卡的类型 
////////////////////////////////////移植修改区///////////////////////////////////
//移植时候的接口
//data:要写入的数据
...
u32 SD_GetCapacity(void)
{
  ...
  //取CSD信息，如果期间出错，返回0
    ...
    if((csd[0]&0xC0)==0x40)
    {									  
	    Capacity=((unsigned long)csd[8])<<8;
		Capacity+=(unsigned long)csd[9]+1;	 
    ...
    {		    
        ...
        //The final result
    	Capacity *= (unsigned long)temp;//字节为单位 	  
    }
